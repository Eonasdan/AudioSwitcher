...
public partial class DeviceTests
{
    ...
    public void Device_Default_Changed_Raises_Event()
    {
        ...
        device.DefaultChanged.Subscribe(x => { reflectedCallback = true; });
    ...
    public void Device_Peak_Volume_Changed_Raises_Event()
    {
        ...
        device.PeakValueChanged.Subscribe(x => { reflectedVolume = x.PeakValue; });
    ...
    public void Device_Property_Changed_Raises_Event()
    {
        ...
        device.PropertyChanged.Subscribe(x => { reflectedProperty = x.PropertyName; });
    ...
    public void Device_State_Changed_Raises_Event()
    {
        ...
        device.StateChanged.Subscribe(x => { reflectedState = x.State; });
    ...
    public void Device_Volume_Changed_Raises_Event()
    {
        ...
        device.VolumeChanged.Subscribe(x => { reflectedVolume = x.Volume; });
