...
internal static class PropertyKeys
{
    ...
    public static readonly PropertyKey PKEY_AUDIO_ENDPOINT_CONTROL_PANEL_PAGE_PROVIDER =
        new(new Guid("1DA5D803-D492-4EDD-8C23-E0C0FFEE7F0E"), 1);

    public static readonly PropertyKey PKEY_AUDIO_ENDPOINT_ASSOCIATION =
        new(new Guid("1DA5D803-D492-4EDD-8C23-E0C0FFEE7F0E"), 2);
    ...
    public static readonly PropertyKey PKEY_AUDIO_ENDPOINT_FULL_RANGE_SPEAKERS =
        new(new Guid("1DA5D803-D492-4EDD-8C23-E0C0FFEE7F0E"), 6);

    public static readonly PropertyKey PKEY_AUDIO_ENDPOINT_SUPPORTS_EVENT_DRIVEN_MODE =
        new(new Guid("1DA5D803-D492-4EDD-8C23-E0C0FFEE7F0E"), 7);

    public static readonly PropertyKey PKEY_AUDIO_ENDPOINT_JACK_SUB_TYPE =
        new(new Guid("1DA5D803-D492-4EDD-8C23-E0C0FFEE7F0E"), 8);
    ...
    public static readonly PropertyKey PKEY_AUDIO_ENGINE_OEM_FORMAT =
        new(new Guid("E4870E26-3CC5-4CD2-BA46-CA0A9A70ED04"), 3);
    ...
    public static readonly PropertyKey PKEY_DEVICE_ICON = new(new Guid("259ABFFC-50A7-47CE-AF08-68C9A7D73366"), 12);

    public static readonly PropertyKey PKEY_SYSTEM_NAME = new(new Guid("B3F8FA53-0004-438E-9003-51A46E139BFC"), 6);
}