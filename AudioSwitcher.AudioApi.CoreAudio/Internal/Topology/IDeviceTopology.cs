...
internal interface IDeviceTopology
{
    ...
    [PreserveSig]
    int GetConnector([In] [MarshalAs(UnmanagedType.U4)] uint index,
    ...
    [PreserveSig]
    int GetSubunit([In] [MarshalAs(UnmanagedType.U4)] uint subunitIndex,
        [Out] [MarshalAs(UnmanagedType.Interface)] out ISubunit subunit);

    [PreserveSig]
    int GetPartById([In] [MarshalAs(UnmanagedType.U4)] uint partId,
